...
const SYNTHESIS_TAIL =
  '\n\nRespond with ONLY a JSON object (no other text). Structure:\n{"summary":"2-3 sentence overview suitable for both line manager and appraisee. Use neutral language and refer to the person as the appraisee or by role — never quote a peer reviewer\'s name in the summary.","highlightQuote":{"text":"one standout quote","attribution":"role, tenure"},"strengths":[{"title":"Theme","body":"2-3 sentences","quote":"short quote","quoteAttr":"role, tenure"}],"development":[{"title":"Theme","body":"2-3 sentences","selfAwareness":"self-review perspective","recommendation":"actionable step"}],"agreedPriority":"one sentence"}\nInclude exactly 3 strengths and 3 development themes. Do NOT include reviewer names in any field — use role and tenure only. The line manager view will surface raw reviewer attribution from the source data separately.';
